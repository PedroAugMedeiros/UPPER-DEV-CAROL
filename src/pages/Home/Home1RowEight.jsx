      ...
      <div className="container-xs flex justify-center md:px-5">
        <div className="flex w-full flex-col gap-16 sm:gap-8">
          <div className="ml-[124px] mr-[150px] flex flex-col items-center md:mx-0">
            ...
            >
              Choose 520 Cleaning Solutions for care and trust. We keep your space spotless and welcoming, so you can
          ...
          <div className="flex flex-col gap-[30px]">
            <div className="mr-6 md:mr-0">
              <div className="flex items-start gap-1 md:flex-col">
                <div className="mt-[122px] flex w-[26%] flex-col items-start gap-3 md:w-full">
                  ...
                  >
                    We treat your home with love and care, ensuring a safe environment for your family.
                  </Text>
                </div>
                <div className="relative h-[524px] flex-1 content-center self-center md:h-auto md:w-full md:flex-none md:self-stretch">
                  <Img
                    src="images/img_ellipse_7.png"
                    alt="Image"
                    className="mx-auto h-[498px] w-[94%] rounded-[248px] object-contain"
                  />
                ...
                <div className="mt-[124px] flex w-[24%] flex-col items-center md:w-full">
                  ...
                  >
                    Our dedicated professionals ensure care and comfort for your family.
                  </Text>
                </div>
              </div>
            </div>
            <div className="ml-1.5 flex items-start md:ml-0 md:flex-col">
              <div className="flex w-[44%] flex-col items-start gap-3 self-center md:w-full">
                ...
                >
                  With seven years of experience, our reliable team delivers high-quality cleaning services you can
                  trust.
                </Text>
              </div>
