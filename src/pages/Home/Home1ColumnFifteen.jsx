...
export default function Home1ColumnFifteen() {
  ...
  return (
    <div className="flex w-[60%] gap-2">
      <div className="mt-24 flex flex-col items-center self-stretch px-14 md:px-10  w-[150%]">
              ...
              <div className="container-xs relative mt-[-14px] flex flex-col items-start px-1.5 md:px-5">
                ...
                >
                  ...
                  <span className="font-medium text-black-900">
                    520 Cleaning Solutions, we offer a free estimate for
                    cleaning services in your region.
                  </span>
                </Text>
              </div>
            </div>
