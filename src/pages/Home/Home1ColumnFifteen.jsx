      ...
      <div className="mr-2 flex w-[90%] flex-col items-center gap-[30px] md:mr-0 md:w-full">
        <div className="relative h-[910px] content-end self-stretch md:h-auto">
          ...
          <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 flex-col items-center">
            <div className="relative z-[13] flex h-[824px] items-center justify-center self-stretch bg-[url(/public/images/img_group_186.png)] bg-cover bg-no-repeat py-[162px] md:h-auto md:py-5">
        ...
        <div className="container-xs flex flex-col items-start gap-[74px] md:gap-[55px] md:px-5 sm:gap-[37px]">
          ...
          <Button className="flex h-[68px] min-w-[326px] flex-row items-center justify-center rounded-[14px] bg-teal-300 px-6 text-center text-[33.03px] text-white-a700 md:text-[31px] sm:px-5 sm:text-[29px]">
            Get a quote today
          </Button>
          <div className="mx-4 flex flex-col items-center gap-[52px] self-stretch md:mx-0 sm:gap-[26px]">
            ...
            <div className="mx-auto flex w-full self-stretch md:mx-0">
              <Slider
                autoPlay
                ...
                items={[...Array(3)].map(() => (
                  <React.Fragment key={Math.random()}>
                    <div className="flex items-center md:flex-col">
                      ...
                      <div className="flex flex-1 flex-col items-end self-end pl-14 pr-[68px] md:self-stretch md:px-5 sm:self-auto">
            ...
            <div className="flex w-[4%] justify-center gap-0.5 md:w-full">
              <div className="h-[12px] w-[12px] rounded-md bg-blue_gray-400" />
              <div className="h-[12px] w-[12px] rounded-md bg-blue_gray-100_01" />
              <div className="h-[12px] w-[12px] rounded-md bg-blue_gray-100_01" />
            </div>
          </div>
        </div>
